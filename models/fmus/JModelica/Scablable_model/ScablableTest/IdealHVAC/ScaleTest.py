...
def translate_simulate(BUILDINGS_LIB,Base_class,ClassName):
    ...
    fmu_name = compile_fmu(ClassName,"IdealHVAC_ScableZones.mo", version=2.0, compiler_options={'extra_lib_dirs':[BUILDINGS_LIB, Base_class]})
...
if __name__=="__main__":
    ...
    shutil.copy2(os.path.join(os.getcwd(), "tmp/Buildings/Experimental/ScalableModels/") + "ScalableDemo/IdealHVAC_ScableZones.mo","IdealHVAC_ScableZones.mo")
