...
model StateTimeEventWithIf
  "This model tests state and time event detection"
...
<p>
This model has one time event at t=1.0 and one state event at t=1.75.
At state and time event times, the output y, y1 switch
from 1 to -1, and 3 to 10 respectively.
</p>
</html>"));
end StateTimeEventWithIf;
