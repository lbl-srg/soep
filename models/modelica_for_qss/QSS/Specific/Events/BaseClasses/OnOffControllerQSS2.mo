...
block OnOffControllerQSS2 "On-off controller"
  ...
  parameter Boolean pre_yBoo_start=true "Value of pre(y) at initial time";
...
equation
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=true, extent={{-100,-100},
        ...
        Text(
          ...
          textString="der_u",
          lineColor={0,0,0}),
        Line(points={{-76.0,-32.0},{-68.0,-6.0},{-50.0,26.0},{-24.0,40.0},{-2.0,
              42.0},{16.0,36.0},{32.0,28.0},{48.0,12.0},{58.0,-6.0},{68.0,-28.0}},
            color={0,0,127}),
...
The on/off controller has been reformulated to reflect the behavior of
<a href=\"modelica://Modelica.Blocks.Logical.OnOffController\">
Modelica.Blocks.Logical.OnOffController</a>
and expose its zero crossing functions for QSS.
This allows emulating <a href=\"modelica://Buildings.Examples.Tutorial.SpaceCooling.System3\">
Buildings.Examples.Tutorial.SpaceCooling.System3</a> with QSS</p>
</html>"));
end OnOffControllerQSS2;
